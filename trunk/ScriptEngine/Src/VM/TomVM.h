...
//#define VM_STATE_STREAMING

#define VM_MAXSTACKCALLS 100        // 1,000,000 stack calls (4 meg stack space)
#define VM_MAXDATA       1000      // 100,000,000 variables (.4 gig of memory)
#define VM_DATATOSTRINGMAXCHARS 400
