...
const char* CCommonWnd::GetWndName() const
{
	return m_szWndName;
}
const char* CCommonWnd::GetWndCaption() const
{
...
void CCommonWnd::SetWndName(const char* pszWndName)
{
	if(pszWndName==NULL||strlen(pszWndName)>MAX_WND_NAME_LEN)
		return;
	strcpy(m_szWndName, pszWndName);
}
void CCommonWnd::SetWndCaption(const char* pszWndCaption)
{
	if(pszWndCaption==NULL||strlen(pszWndCaption)>MAX_WND_NAME_LEN)
		return;
...
void CCommonWnd::SetID(int nID)
{
	m_nWndID = nID;	
}
int CCommonWnd::GetID() const
{
	return m_nWndID;
}
